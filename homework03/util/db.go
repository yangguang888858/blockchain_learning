...
func NewTestDB(filename string) *gorm.DB {
...
func newSQLiteDB(filename string) (*gorm.DB, error) {
	...
	return gorm.Open(sqlite.Open(dbPath), &gorm.Config{
		...
		NamingStrategy: schema.NamingStrategy{
			...
			SingularTable: true,  // Use singular table names (User -> user instead of users)
...
func newMySQLDB() (*gorm.DB, error) {
	...
	if dsn == "" {
		...
		fmt.Println("using default MySQL DSN, set TEST_MYSQL_DSN in .env file or environment variable to override")
	}
...
func newPostgresDB() (*gorm.DB, error) {
	...
	if dsn == "" {
		...
		fmt.Println("using default PostgreSQL DSN, set TEST_POSTGRES_DSN in .env file or environment variable to override")
	}
